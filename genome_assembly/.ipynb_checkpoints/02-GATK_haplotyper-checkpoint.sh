...
input_folder="/nesi/nobackup/ga03488/Amy/FAW/assemblies/test_data/alignments_sam/corrected_bam/"
output_folder="/nesi/nobackup/ga03488/Amy/FAW/assemblies/test_data/alignments_bam/"
...
for sam_file in "${input_folder}"*.sam; do
  ...
  gatk HaplotypeCaller \
    -R /nesi/project/ga03488/Amy/Scripts/genome_assembly/reference/sfC.ver7.fa \
    -I "${sorted_bam_file}" \
    -O "${gvcf_file}" \
    -ERC GVCF
